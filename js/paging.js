(function($, window, document) {
    ...
    Paging.prototype = {
        ...
        createDom: function() {
            ...
            that.options.jump ? jumpDom = '<span class="lf zhiti" style="line-height: 32px">跳至</span> <input onchange="changeYm()" type="text" placeholder="1" class="jump-text" id="jumpText">' +
            //'<button type="button" class="jump-button zhiti" id="jumpBtn">跳转</button>'
        ...
        bindEvents: function() {
            var that = this,
                ...
                jumpBtn = $('#jumpBtn'),
                jumpText = $('#jumpText');
console.log(lis[0].offsetWidth,liWidth)
